...
var dialogue_line: DialogueLine:
	set(next_dialogue_line):
		...
		#responses_menu.hide()
		# Hiding the responses menu (a VBoxContainer) resizes everything, which
		# looks shit. Instead, remove all of the options at the start, then
		# run "set_responses" again after the dialogue has finished typing.
